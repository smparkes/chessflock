...
Checkmate.Board.View.SVG =
  new Checkmate.Board.View.Class(function SVG(element){
    ...
    hidePieces: function() {
      Checkmate.$(".black,.white").not(".square").hide();
    },
    showPieces: function() {
      Checkmate.$(".black,.white").not(".square").show();
    },
    ...
    populatePieces: function() {
      ...
      for(var color_index in colors) {
        ...
        for(var layout_index in layout) {
          ...
          pieces.push(piece = new Checkmate.Board.View.SVG.Piece(this,color,type,svg,offset+sign*positions[0],horizontal));
          ...
          for(var i=1; i<positions.length; i++) {
            ...
            pieces.push(new Checkmate.Board.View.SVG.Piece(this,color,type,svg,offset+sign*positions[i],horizontal));
          }
        }
      }
...
Checkmate.Board.View.SVG.Piece = Checkmate.Board.View.SVG.Class(function Piece(view,color,type,svg,position,horizontal){
  this.view = view;
  this.color = color;
  this.type = type;
  this.svg = svg;
