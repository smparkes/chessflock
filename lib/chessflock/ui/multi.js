...
(function($){
  ...
  ChessFlock.UI.Multi = new ChessFlock.UI.Class(function Multi(){
    ...
    this.resize();
       ...
       game_event: function(/*...*/) {
         global.console.debug(global.$.print(arguments));
         throw new Error("implement");
       },
       ...
       join: function(opponent) {
         ...
         if (!(game instanceof Dramatis.Actor.Name)) {
         ...
         global.console.debug("house",global.$.print(Actor.id(view)));
         if (!(game instanceof Dramatis.Actor.Name)) {
           throw new Error("help");
         }
