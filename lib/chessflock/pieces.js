"use strict";
ChessFlock.Pieces = new ChessFlock.Class(function Pieces(positions){
  var layout = [
    [ "rook", [0, 7] ],
    [ "knight", [1, 6] ],
    [ "bishop", [2, 5] ],
  ...
  move: function(old_position, new_position) {
    ...
    console.debug("moving "+old_position+" to "+ new_position);
    console.debug(this.positions[old_position]);
    this.positions[new_position] = this.positions[old_position];
    var nil;
    this.positions[old_position] = nil;    
