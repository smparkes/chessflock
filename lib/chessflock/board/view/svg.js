...
(function($){
      ...
      turn_on: function() {
        ...
        svg.
          bind("mousedown",function(ev){
            ...
            console.debug("start",$.print(start));
            var offset = self.page_to_offset(view, start, ev.pageX, ev.pageY);
            console.debug("off",$.print(offset));
            view.offset(offset);
  ...
  ChessFlock.Board.View.SVG.Piece =
    ...
    place: function(new_position, animate) {
      ...
      if (animate) {
        $(this.svg).animate({svgTransform: translate}, "fast");
        $(this.svg_rotate).animate({svgTransform: rotate}, "fast");
      } else {
