...
(function($){
  ...
  ChessFlock.Board.View.SVG =
    new ChessFlock.Board.View.Class(function SVG(element){
      ...
      setTimeout(function(){
        console.debug("after",self,self.constructor.prototype.toJSON);
      },100);
    }, [
      Super
    ], {
      ...
      place: function() {
        if (this.pieces) {
          ...
          $(this.svg).find(".piece").css("opacity",0);
        }
      },
        ...
        if (true) {
          ...
          global.setTimeout(function(){
            $.each(self.pieces,function(){
              this.rotate(180,duration,complete);
            });
          },duration*0.8);
        }
      },
      attach: function(game) {
        if (false) {
          ...
          this.showPieces();
          this.reset();
          Super.prototype.attach.apply(this,arguments);
        }
      }
    });
  ...
  ChessFlock.Board.View.SVG.Piece =
    ...
    place: function() {
      var p = Math.abs(this.view._origin - this.position);
